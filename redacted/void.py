    ...
    def __init__(self):
        ...
        def proceed():
            ...
            if game.game_state.get_stat("test") == "infected":
                ending = "3"
                game.game_state.show_message(ColorString(("Instead of the results, you get surprised with several enforcers at your doorstep. They don't even tell you what's wrong. You are taken and transported to an unfamiliar room. You starve. ","white"),("They knew. This was more than a skill test. ","cyan"),("Dangerous ","yellow"),("individuals ","red"),("and their Art ","green"),("must be eliminated.","red")))
